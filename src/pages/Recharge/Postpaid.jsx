    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="flex flex-col flex-grow p-4">
        <main className="bg-white dark:bg-gray-800 rounded-lg p-6 mt-5 shadow-lg w-full">
          <h1 className="text-3xl font-bold text-center mb-8 text-primary_light dark:text-blue-400">Postpaid Plans</h1>
          ...
          <div className="mb-6">
            {userId && currentPlan && currentPlan.planType === 'POSTPAID' && (
              <div
                className="flex justify-between items-center bg-blue-100 dark:bg-blue-900 p-4 rounded-md"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {filteredPlans.map((plan, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 flex flex-col justify-between border border-gray-200 dark:border-gray-700"
