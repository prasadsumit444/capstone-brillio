...
const darkTheme = {
  ...lightTheme,
  headerBgColor: '#000', // Change to dark background color
  headerFontColor: '#fff', // Change to light font color
  botBubbleColor: '#000', // Change to dark bubble color
  botFontColor: '#fff', // Change to light font color
};
  ...
  return (
    <div className="App">
      <button onClick={toggleChat} style={{ position: 'fixed', bottom: '20px', right: '20px', background: 'none', border: 'none', cursor: 'pointer' }}>
        <TfiHeadphoneAlt size="2em" style={{ color: isDarkTheme ? '#fff' : '#000' }} onClick={toggleTheme} />
      </button>
      {showChat && (
