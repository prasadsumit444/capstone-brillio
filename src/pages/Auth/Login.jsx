        ...
        <section className="relative flex h-32 items-center bg-gray-900 lg:col-span-5 lg:h-screen xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <h2 className="mt-4 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
              Stay Connected. Log In to <span className=" text-blue-500">asaap</span>.
            </h2>

            <p className="mt-4 leading-relaxed text-white/90">
              Reconnect with Excellence. Log In to Access Your World of Seamless Communication.
            </p>
          </div>
        </section>

        <main
          className="flex  items-start justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 max-w-2xl"
        >
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <div>
              <form onSubmit={handleLogin} className="mt-6 grid grid-cols-6 gap-4 max-w-2xl">
                ...
                <div className="col-span-6">
                  <p className=" text-xs text-gray-500 text-right">
                    <button type="button" onClick={() => handleResetPasswordModal(true)} className="text-gray-700 font-medium">Forgot Password? </button>
                  </p>
                </div>
              ...
              {showResetPasswordModal ? (
                <ResetPasswordModal onClose={() => handleResetPasswordModal(false)} />
              ) : (
                <></>
              )
              }
